...
const CategoryPage = () => {
  const articles = [
    {
      ...
      title: 'বাঙলা ভাষিকদের বাংলাদেশ ও পশ্চিমবঙ্গের রাজসিংহ পর্ব: সংস্থান সংকট',
      author: 'Indianexpress.Com',
      date: 'January 5, 2025',
      excerpt: 'বর্তমান বিশ্বে বাংলা ভাষী জনগোষ্ঠীর একটি বিশাল অংশ বাংলাদেশ ও পশ্চিমবঙ্গে বসবাস করেন। তবে এই দুই অঞ্চলে বাংলা ভাষা ও সংস্কৃতির প্রসার এবং সংরক্ষণ নিয়ে রয়েছে নানা সংস্থান সংকট।'
    },
    {
      id: 2,
      category: 'ভ্রমণ',
      ...
      author: 'Indianexpress.Com',
      date: 'January 2, 2025',
      excerpt: 'বান্দরবান জেলা দেশের পার্বত্য এলাকাগুলির মধ্যে একটি বিখ্যাত স্থান। এখানে পাহাড়, নদী, উপত্যকা সবকিছুই মিলেমিশে একটি অপরূপ প্রাকৃতিক দৃশ্য তৈরি করেছে। বান্দরবান ভ্রমণ মানে শুধু প্রকৃতি দেখা নয়, এটি একটি অবিস্মরণীয় অভিজ্ঞতা।'
    },
    {
      id: 3,
      category: 'ভ্রমণ',
      ...
      author: 'Indianexpress.Com',
      date: 'January 2, 2025',
      excerpt: 'Sikkim অত্যাশ্চর্য হিমালয়ের কোলে অবস্থিত একটি ছোট্ট রাজ্য যা তার প্রাকৃতিক সৌন্দর্য, বৌদ্ধ মঠ এবং বৈচিত্র্যময় সংস্কৃতির জন্য বিখ্যাত। পাহাড়, হিমবাহ এবং সবুজ উপত্যকা নিয়ে গঠিত এই অঞ্চলটি প্রকৃতিপ্রেমীদের জন্য স্বর্গ।'
    },
    {
      id: 4,
      category: 'ভ্রমণ',
      categoryEn: 'Travel',
      image: 'https://images.unsplash.com/photo-1568454537842-d933259bb258?w=800&h=400&fit=crop',
      title: 'কলকাতা এক শহরের ডেডের যাত্রার গল্প',
      author: 'Indianexpress.Com',
      date: 'January 2, 2025',
      excerpt: 'কলকাতা, পশ্চিমবঙ্গের রাজধানী শহরটি, একটি সমৃদ্ধ ইতিহাস এবং সংস্কৃতির কেন্দ্র। এই শহরটি তার ঐতিহ্যবাহী রাস্তা, পুরানো দালানকোঠা এবং ঐতিহাসিক স্মৃতিস্তম্ভের জন্য বিখ্যাত। কলকাতার রাস্তায় হাঁটলে মনে হয় যেন সময় থমকে আছে।'
    }
  ];
  ...
  const tags = [
    'অর্থনীতি', 'আধুনিক শিক্ষা', 'কবিতা', 'কলম',
    'কলেজ জীবনে শেষ', 'খেলা', 'ঐতিহ্য',
    'গল্প', 'চাকরি', 'জীবনধারা',
    'তথ্য', 'তথ্য প্রযুক্তি', 'তথ্য সমাজ', 'প্রকৃতির চোখে',
    'প্রবন্ধ', 'প্রাচীন ইতিহাস', 'বই ও চলচিত্র',
    'বিজ্ঞান', 'ভ্রমণ', 'রাজনীতি',
    'রোমান্টিক প্রেমের গল্প', 'শিক্ষা', 'স্বাস্থ্য'
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {articles.map((article) => (
              <div key={article.id} className="bg-white rounded-lg shadow-sm mb-6 overflow-hidden hover:shadow-md transition-shadow">
                <img 
                  src={article.image} 
                  alt={article.title}
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <ul className="space-y-3">
                {recentPosts.map((post, index) => (
                  <li key={index} className="text-gray-700 hover:text-pink-600 cursor-pointer transition-colors text-sm">
                    {post}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <ul className="space-y-2">
                {['December 2024', 'November 2024', 'October 2024', 'September 2024', 'August 2024', 'July 2024', 'June 2024'].map((month, index) => (
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <div className="mb-4">
                <p className="text-2xl font-bold text-gray-800 mb-2">Hello, I am Monty Leo</p>
                <p className="text-gray-600 text-sm mb-4">
                  Where I welcome you (the readers) of my Blog.
                  নমস্কার পাঠকবৃন্দ, আপনাদের স্বাগত জানাই আমার ব্লগে। এই ব্লগে আমি নানা বিষয়ে লিখে থাকি।
                </p>
